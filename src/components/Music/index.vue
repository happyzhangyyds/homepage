...
const AsyncPlayer = defineAsyncComponent(() =>
  import("@/components/Player/index.vue")
);
...
const handleSpaceKey = (e) => {
  if (e.code === "Space") {
    e.preventDefault();
    if (playerRef.value && typeof playerRef.value.playToggle === "function") {
      changePlayState();
    }
  }
};
...
const changeMusicIndex = (type) => {
  if (playerRef.value && typeof playerRef.value.changeSong === "function") {
...
watch(
  ...
  (value) => {
    ...
    if (playerRef.value && typeof playerRef.value.changeVolume === "function") {
